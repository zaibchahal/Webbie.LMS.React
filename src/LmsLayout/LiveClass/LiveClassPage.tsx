...
const LiveClassPage = () => {
    ...
    const registerChatEvents = (connect: any) => {
        connect.on('getChatMessage', function (message: any) {
            // Mesage received here
        });
        connect.on('getUserConnectNotification', function (friend: any, isConnected: any) {
            // Connection status hereF
        });

        connect.on('getUserStateChange', function (friend: any, state: any) {
            // User state here
        });
    };
                        ...
                        <Card stretch>
                            <CardBody>
                                {[1, 2, 3].map((item: any, index: any) => (
                                    <div key={index} className='d-flex justify-content-between py-2 align-items-center'>
                                        <span className='fs-5'>
                                            <Icon
                                                className='mx-2'
                                                icon='PictureAsPdf'
