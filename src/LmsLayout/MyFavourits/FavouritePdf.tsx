...
interface IFavouritePDFProps {
    isFluid?: boolean;
}
const FavouritePDF: FC<IFavouritePDFProps> = ({ isFluid }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const d = await getFavouriteList(3, session?.accessToken);
            ...
            <Card stretch={isFluid}>
                <CardHeader borderSize={1}>
                    <CardLabel icon='BookmarkAdd' iconColor='info'>
                        <CardTitle>List of my favourite PDF</CardTitle>
                    </CardLabel>
                    {/*<CardActions>*/}
                    {/*<Button*/}
                    {/*    color='info'*/}
