...
export const setCookie = (name: any, value: any, days: number, path?: any, domain?: any) => {
...
export const jzSwal = {
    success: (msg: string) => {
        //Swal.fire({ position: 'top-end', icon: 'success', title: msg, showConfirmButton: false, timer: 1500 })
    },
    error: (msg: string) => {
        //Swal.fire({ position: 'top-end', icon: 'error', title: msg, showConfirmButton: false, timer: 1500 })
    }
}
