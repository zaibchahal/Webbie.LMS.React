...
import { IUserProps } from '../../common/data/userSessionService';
...
export const ChatMessages: FC<IChatMessagesProps> = ({ messages, isReply, ...props }) => {
	return (
		<div className='chat-messages col-6' {...props}>
			{messages.map((i) => (
				<div>
					{/* <span className='text-bolder'>{i.user.name}</span> */}
					<>
						...
						<div className='ms-3'>
							<a
								href='#'
								className='fs-7 fw-bolder text-gray-600 text-hover-primary me-1 text-decoration-none'>
								{i.user.name}
							</a>
						</div>
					</>
